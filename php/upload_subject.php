...
if(isset($_POST["import"]))
{
    ...
    if($_FILES["file"]["size"] > 0)
    {
        ...
        while(($data = fgetcsv($file, 1000, ",")) !== FALSE)
        {
            ...
            $sql = "INSERT INTO `subj`(`subject_code`, `subject_name`, `subject_type`, `dept_name`, `semester`)
            VALUES ('$subject_code','$subject_name', '$subject_type', '$dept_name','$semester')";
...
<div class = "guidelines">
    ...
    <p>Follow below steps to upload Subject details from CSV file.</p>
    <br>
    <p>Don't include column header in CSV file</p>
    <br>
    <p>In CSV file write fields in given order <br>(subject_code, subject_name, subject_type, dept_name, semester)</p>
    <br>
    <p>In subject type write (theory) or (practical) or (theory and practical) or (mock drill)</p>
    <br>
    ...
    <form action="upload_subject.php" method = "post" name = "upload_excel" enctype="multipart/form-data">

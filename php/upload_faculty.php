...
if(isset($_POST["import"]))
{
    ...
    if($_FILES["file"]["size"] > 0)
    {
        ...
        {
            $faculty_email = $data[0];
            $name = $data[1];

            $sql = "INSERT INTO `faculty`(`faculty_email`, `name`) VALUES ('$faculty_email','$name')";
...
<title>Upload Faculty Details</title>
...
<div class = "guidelines">
    ...
    <p>Follow below steps to upload Faculty details from CSV file.</p>
    <br>
    <p>Don't include column header in CSV file</p>
    <br>
    <p>In CSV file write fields in given order <br>(faculty_email, name)</p>
    <br>
    ...
    <form action="upload_faculty.php" method = "post" name = "upload_excel" enctype="multipart/form-data">

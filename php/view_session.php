...
<header>
    ...
    <form action="view_session.php" method = "post">
        ...
        <input type="submit" name = "view_all" value = "View All Session">
    ...
    <form action="view_session.php" method = "post">
        ...
        <input type="number" id = "year" name = "year" min="2022" max="2099" step="1" value="2022" required>
    ...
    <?php
        ...
        else if(isset($_POST['Search']))
        {
            ...
            printSessionTable('Search', $dept_name, $semester, $duration, $year);
        }
        else
        {
            printSessionTable('view_all', ' ', ' ', ' ', ' ');

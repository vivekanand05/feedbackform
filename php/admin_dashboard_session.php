...
<body>
    ...
    <div style="text-align:center;"><a href="insert_session.php"><img class="icon" src="write.png" alt=""></a><p>Create Academic Session</p></div>

    <div style="text-align:center;"><a href="upload_session.php"><img class="icon" src="upload.png" alt=""></a><p>Upload Academic Session Details</p></div>

    <div style="text-align:center;"><a href="view_session.php"><img class="icon" src="view.png" alt=""></a><p>View Session</p></div>

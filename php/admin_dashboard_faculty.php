...
<body>
    ...
    <div style="text-align:center;"><a href="insert_faculty.php"><img class="icon" src="write.png" alt=""></a><p>Insert Faculty</p></div>

    <div style="text-align:center;"><a href="upload_faculty.php"><img class="icon" src="upload.png" alt=""></a><p>Upload Faculty Details</p></div>

    <div style="text-align:center;"><a href="view_faculty.php"><img class="icon" src="view.png" alt=""></a><p>View Faculty</p></div>
